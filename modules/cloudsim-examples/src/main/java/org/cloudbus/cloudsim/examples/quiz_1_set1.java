...
public class quiz_1_set1 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            // {Arrival Time, Burst Time(ms), Deadline}
            double[][] cloudletData = {
                    {0.0, 10000, 200.0},
                    {2.0, 50000, 180.0},
                    {1.0, 20000, 40.0},
            ...
            for (int i = 0; i < 5; i++) {
                ...
                Cloudlet cloudlet = new Cloudlet(i, burstTime, pesNumber, 300,
                        300, utilizationModel, utilizationModel,
            ...
            List<CloudletInfo> deadlineSchedule = applyScheduling(cloudletInfoList);

            System.out.println();
            printEDFSchedule(deadlineSchedule);

            cloudletList.clear();
            for (CloudletInfo info : deadlineSchedule) {
            ...
            printCloudletList(newList, deadlineSchedule);
            calculateStatistics(newList, deadlineSchedule);
    ...
    private static List<CloudletInfo> applyScheduling(List<CloudletInfo> cloudletInfoList) {
        System.out.println("Applying Scheduling Algorithm");
    ...
    private static void printCloudletInputInfo(List<CloudletInfo> list) {
        ...
        System.out.println("Task    AT(s)    BT(ms)  Deadline(s)  ");
        System.out.println("----    -----    ------  -----------  ");

        for (CloudletInfo info : list) {
            System.out.printf("%4d    %5.1f    %6d    %8.1f%n",
